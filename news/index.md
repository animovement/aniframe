...
- The tail of
  ...
  /
  [`restructure_anievent()`](https://animovement.dev/aniframe/reference/restructure_anievent.md),
...
- The
  [`print.aniframe_metadata()`](https://animovement.dev/aniframe/reference/print.aniframe_metadata.md)
...
- Factored the strip-class /
  ...
  [`preserve_animovement_class()`](https://animovement.dev/aniframe/reference/preserve_animovement_class.md).
- [`resolve_unit_time_calibration()`](https://animovement.dev/aniframe/reference/resolve_unit_time_calibration.md)
