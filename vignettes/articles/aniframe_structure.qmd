...
[metadata attribute](aniframe_metadata.html) and the
[connections field](aniframe_connections.html) for skeletons and
networks.
...
- [The metadata attribute](aniframe_metadata.html) — units, origin,
  sampling rate, and the setters that keep them consistent with the
  data.
- [Connections](aniframe_connections.html) — recording skeleton edges
