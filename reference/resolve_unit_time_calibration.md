...
Shared between
[`set_unit_time.aniframe()`](https://animovement.dev/anicore/reference/set_unit_time.md)
and
[`set_unit_time.anievent()`](https://animovement.dev/anicore/reference/set_unit_time.md).
