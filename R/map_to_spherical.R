...
map_to_spherical <- function(data) {
  ensure_is_aniframe(data) # your existing sanity check
  ensure_is_cartesian(data) # makes sure x, y, z exist
  ...
  ensure_is_spherical(data) # optional validator (see below)
  as_aniframe(data)
}
