...
#>  1          1 head           1     1     1 -0.522  -0.312       0.761
#>  2          1 head           1     1     2 -0.304   0.526       0.464
#>  3          1 head           1     1     3 -1.25    0.908       0.467
#>  4          1 head           1     1     4 -0.0975  0.772       0.602
#>  5          1 head           1     1     5 -0.793   0.166       0.781
#>  6          1 neck           1     1     1  0.276   0.0582      0.590
#>  7          1 neck           1     1     2 -0.0242 -0.814       0.797
#>  8          1 neck           1     1     3  1.65    0.171       0.446
#>  9          1 neck           1     1     4  0.748  -1.27        0.590
#> 10          1 neck           1     1     5 -0.225  -0.611       0.777
#> # ℹ 20 more rows
```
...
#>    <fct> <int> <int>   <dbl> <dbl>
#>  1 A         1     1 0.155   0.832
#>  2 A         1     1 0.00616 0.637
#>  3 A         1     2 0.236   0.632
#>  4 A         1     2 0.0303  0.431
#>  5 B         1     1 0.824   0.245
#>  6 B         1     2 0.949   0.997
#>  7 B         2     1 0.0143  0.127
#>  8 B         2     2 0.875   0.475
#>  9 C         2     1 0.253   0.715
#> 10 C         2     1 0.119   0.848
#> 11 C         2     2 0.945   0.928
#> 12 C         2     2 0.783   0.759
```
