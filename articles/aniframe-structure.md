...
#>  1          1 head           1     1     1  1.08   0.918       0.875
#>  2          1 head           1     1     2  1.33   0.211       0.662
#>  3          1 head           1     1     3 -0.746  1.55        0.459
#>  4          1 head           1     1     4  1.33   1.72        0.808
#>  5          1 head           1     1     5 -1.79  -0.521       0.662
#>  6          1 neck           1     1     1  1.18   0.0283      0.726
#>  7          1 neck           1     1     2 -0.467  1.37        0.841
#>  8          1 neck           1     1     3 -0.947  0.795       0.545
#>  9          1 neck           1     1     4 -1.12   0.103       0.658
#> 10          1 neck           1     1     5 -1.35   0.610       0.874
#> # ℹ 20 more rows
```
...
#>  3 A         1     2 0.700 0.357 
#>  4 A         1     2 0.161 0.244 
#>  5 B         1     1 0.129 0.0626
#>  6 B         1     2 0.857 0.623 
#>  7 B         2     1 0.482 0.891 
#>  8 B         2     2 0.557 0.0737
#>  9 C         2     1 0.770 0.624 
#> 10 C         2     1 0.369 0.697 
#> 11 C         2     2 0.413 0.528 
#> 12 C         2     2 0.561 0.306
```
