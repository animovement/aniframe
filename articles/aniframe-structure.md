...
#>  1          1 head           1     1     1  0.312   0.687      0.805
#>  2          1 head           1     1     2 -2.00   -0.374      0.461
#>  3          1 head           1     1     3  0.974  -2.00       0.455
#>  4          1 head           1     1     4  0.905   2.27       0.527
#>  5          1 head           1     1     5 -0.146  -2.09       0.318
#>  6          1 neck           1     1     1  0.932  -0.821      0.571
#>  7          1 neck           1     1     2  0.756  -0.218      0.738
#>  8          1 neck           1     1     3  0.0838 -0.656      0.450
#>  9          1 neck           1     1     4 -0.507  -0.156      0.765
#> 10          1 neck           1     1     5  0.772  -1.69       0.646
#> # ℹ 20 more rows
```
...
#>  5 B         1     1 0.807  0.478
#>  6 B         1     2 0.258  0.604
#>  7 B         2     1 0.0464 0.774
#>  8 B         2     2 0.501  0.351
#>  9 C         2     1 0.458  0.194
#> 10 C         2     1 0.328  0.456
#> 11 C         2     2 0.798  0.958
#> 12 C         2     2 0.0532 0.949
```
