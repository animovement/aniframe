...
#>  1          1 head           1     1     1 -1.67   -0.961       0.859
#>  2          1 head           1     1     2 -0.107   2.47        0.912
#>  3          1 head           1     1     3  0.0211 -1.15        0.842
#>  4          1 head           1     1     4  1.00    1.69        0.621
#>  5          1 head           1     1     5  0.872   0.543       0.610
#>  6          1 neck           1     1     1  0.185  -0.832       0.740
#>  7          1 neck           1     1     2 -0.164  -1.40        0.754
#>  8          1 neck           1     1     3 -0.709  -1.53        0.654
#>  9          1 neck           1     1     4  0.175   0.563       0.415
#> 10          1 neck           1     1     5  1.60    0.0248      0.827
#> # ℹ 20 more rows
```
...
#>  5 B         1     1 0.114  0.532
#>  6 B         1     2 0.486  0.162
#>  7 B         2     1 0.0445 0.386
#>  8 B         2     2 0.0171 0.227
#>  9 C         2     1 0.374  0.754
#> 10 C         2     1 0.406  0.956
#> 11 C         2     2 0.954  0.439
#> 12 C         2     2 0.429  0.858
```
