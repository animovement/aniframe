...
#>  1          1 head           1     1     1  0.709  0.788       0.785
#>  2          1 head           1     1     2  0.865 -0.507       0.547
#>  3          1 head           1     1     3  0.682 -2.02        0.916
#>  4          1 head           1     1     4 -1.09   0.486       0.724
#>  5          1 head           1     1     5  0.498  0.402       0.358
#>  6          1 neck           1     1     1 -0.692  0.601       0.635
#>  7          1 neck           1     1     2 -0.555 -1.74        0.795
#>  8          1 neck           1     1     3 -0.806  1.44        0.803
#>  9          1 neck           1     1     4 -0.684 -0.571       0.708
#> 10          1 neck           1     1     5  0.165 -0.0428      0.768
#> # ℹ 20 more rows
```
...
#>  2 A         1     1 0.691   0.324 
#>  3 A         1     2 0.239   0.936 
#>  4 A         1     2 0.0269  0.398 
#>  5 B         1     1 0.762   0.983 
#>  6 B         1     2 0.655   0.644 
#>  7 B         2     1 0.203   0.560 
#>  8 B         2     2 0.00347 0.0473
#>  9 C         2     1 0.224   0.0396
#> 10 C         2     1 0.162   0.530 
#> 11 C         2     2 0.291   0.0424
#> 12 C         2     2 0.971   0.235
```
