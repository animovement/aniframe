...
#>  1          1 head           1     1     1  1.81    1.18        0.564
#>  2          1 head           1     1     2 -2.09   -0.324       0.460
#>  3          1 head           1     1     3 -1.56   -0.101       0.780
#>  4          1 head           1     1     4  1.16   -2.37        0.850
#>  5          1 head           1     1     5  0.385  -2.23        0.668
#>  6          1 neck           1     1     1 -0.0428 -0.0410      0.539
#>  7          1 neck           1     1     2  0.427   0.423       0.624
#>  8          1 neck           1     1     3 -1.53   -0.202       0.788
#>  9          1 neck           1     1     4  1.10    0.406       0.899
#> 10          1 neck           1     1     5  0.639   1.01        0.986
#> # ℹ 20 more rows
```
...
#>    <fct> <int> <int>  <dbl>  <dbl>
#>  1 A         1     1 0.0554 0.793 
#>  2 A         1     1 0.752  0.101 
#>  3 A         1     2 0.199  0.484 
#>  4 A         1     2 0.0815 0.116 
#>  5 B         1     1 0.549  0.369 
#>  6 B         1     2 0.704  0.103 
#>  7 B         2     1 0.315  0.401 
#>  8 B         2     2 0.858  0.982 
#>  9 C         2     1 0.508  0.264 
#> 10 C         2     1 0.783  0.398 
#> 11 C         2     2 0.764  0.905 
#> 12 C         2     2 0.506  0.0519
```
