...
#>  1          1 head           1     1     1 -0.358   1.56        0.608
#>  2          1 head           1     1     2 -0.607   0.345       0.618
#>  3          1 head           1     1     3  0.363  -1.22        0.919
#>  4          1 head           1     1     4  0.794   0.108       0.862
#>  5          1 head           1     1     5  0.0160  0.676       0.702
#>  6          1 neck           1     1     1 -0.429  -0.0695      0.750
#>  7          1 neck           1     1     2 -2.50    0.220       0.406
#>  8          1 neck           1     1     3 -0.180   0.747       0.834
#>  9          1 neck           1     1     4  0.297  -0.605       0.772
#> 10          1 neck           1     1     5  0.0517 -0.472       0.678
#> # ℹ 20 more rows
```
...
#>  7 B         2     1 0.655  0.287 
#>  8 B         2     2 0.339  0.469 
#>  9 C         2     1 0.654  0.0422
#> 10 C         2     1 0.605  0.535 
#> 11 C         2     2 0.0636 0.0815
#> 12 C         2     2 0.419  0.0452
```
