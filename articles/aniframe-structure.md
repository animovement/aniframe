...
#>  1          1 head           1     1     1  0.796 -0.827       0.597
#>  2          1 head           1     1     2  1.42  -0.645       0.810
#>  3          1 head           1     1     3  0.496 -0.572       0.678
#>  4          1 head           1     1     4  1.55  -1.20        0.550
#>  5          1 head           1     1     5 -0.590 -3.15        0.960
#>  6          1 neck           1     1     1 -1.40   0.814       0.794
#>  7          1 neck           1     1     2  0.413  0.654       0.664
#>  8          1 neck           1     1     3 -0.192  0.0133      0.869
#>  9          1 neck           1     1     4  1.24   0.485       0.567
#> 10          1 neck           1     1     5 -0.378  0.229       0.454
#> # ℹ 20 more rows
```
...
#>  4 A         1     2 0.841  0.978
#>  5 B         1     1 0.697  0.674
#>  6 B         1     2 0.0879 0.115
#>  7 B         2     1 0.149  0.253
#>  8 B         2     2 0.0757 0.608
#>  9 C         2     1 0.139  0.940
#> 10 C         2     1 0.310  0.917
#> 11 C         2     2 0.472  0.927
#> 12 C         2     2 0.398  0.787
```
