...
#>  1          1 head           1     1     1 -2.53   1.58        0.969
#>  2          1 head           1     1     2  0.243  0.562       0.880
#>  3          1 head           1     1     3  0.405 -0.0732      0.520
#>  4          1 head           1     1     4  1.36   0.596       0.725
#>  5          1 head           1     1     5 -0.288 -0.645       0.450
#>  6          1 neck           1     1     1 -0.575 -1.09        0.859
#>  7          1 neck           1     1     2  0.364  0.174       0.519
#>  8          1 neck           1     1     3  1.29   0.522       0.883
#>  9          1 neck           1     1     4 -1.25   1.05        0.706
#> 10          1 neck           1     1     5 -0.182 -0.0380      0.886
#> # ℹ 20 more rows
```
...
#>    <fct> <int> <int>  <dbl> <dbl>
#>  1 A         1     1 0.565  0.113
#>  2 A         1     1 0.0199 0.325
#>  3 A         1     2 0.501  0.419
#>  4 A         1     2 0.330  0.196
#>  5 B         1     1 0.979  0.259
#>  6 B         1     2 0.124  0.194
#>  7 B         2     1 0.820  0.704
#>  8 B         2     2 0.0597 0.251
#>  9 C         2     1 0.367  0.661
#> 10 C         2     1 0.909  0.197
#> 11 C         2     2 0.552  0.357
#> 12 C         2     2 0.649  0.729
```
