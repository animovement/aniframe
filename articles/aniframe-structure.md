...
#>  1          1 head           1     1     1 -0.0569 -0.352       0.729
#>  2          1 head           1     1     2 -0.765   0.134       0.923
#>  3          1 head           1     1     3 -0.319  -0.344       0.893
#>  4          1 head           1     1     4 -0.0553 -0.0364      0.600
#>  5          1 head           1     1     5 -0.373   0.391       0.855
#>  6          1 neck           1     1     1 -1.05   -1.09        0.715
#>  7          1 neck           1     1     2 -0.829   0.686       0.532
#>  8          1 neck           1     1     3 -1.11   -1.64        0.584
#>  9          1 neck           1     1     4 -0.336  -1.37        0.737
#> 10          1 neck           1     1     5  0.669  -1.26        0.576
#> # ℹ 20 more rows
```
...
#>  5 B         1     1 0.634 0.201 
#>  6 B         1     2 0.811 0.706 
#>  7 B         2     1 0.709 0.0814
#>  8 B         2     2 0.992 0.657 
#>  9 C         2     1 0.672 0.563 
#> 10 C         2     1 0.889 0.120 
#> 11 C         2     2 0.979 0.639 
#> 12 C         2     2 0.105 0.942
```
