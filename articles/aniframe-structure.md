...
#>  1          1 head           1     1     1 -0.588 -0.163      0.692
#>  2          1 head           1     1     2  0.766  0.122      0.807
#>  3          1 head           1     1     3 -0.320  0.761      0.873
#>  4          1 head           1     1     4  1.13   1.42       0.673
#>  5          1 head           1     1     5 -0.377 -0.917      0.708
#>  6          1 neck           1     1     1 -0.842 -0.992      0.722
#>  7          1 neck           1     1     2 -0.788  1.06       0.666
#>  8          1 neck           1     1     3 -0.496 -0.147      0.384
#>  9          1 neck           1     1     4 -1.34   1.03       0.893
#> 10          1 neck           1     1     5  1.58   0.662      0.887
#> # ℹ 20 more rows
```
...
#>    <fct> <int> <int>   <dbl>  <dbl>
#>  1 A         1     1 0.136   0.858 
#>  2 A         1     1 0.00496 0.271 
#>  3 A         1     2 0.123   0.304 
#>  4 A         1     2 0.489   0.765 
#>  5 B         1     1 0.218   0.0681
#>  6 B         1     2 0.613   0.633 
#>  7 B         2     1 0.271   0.556 
#>  8 B         2     2 0.0816  0.500 
#>  9 C         2     1 0.983   0.354 
#> 10 C         2     1 0.801   0.235 
#> 11 C         2     2 0.495   0.438 
#> 12 C         2     2 0.137   0.217
```
