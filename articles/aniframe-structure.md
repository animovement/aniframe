...
#>  1          1 head           1     1     1 -0.662   0.170       0.814
#>  2          1 head           1     1     2  0.729  -0.198       0.501
#>  3          1 head           1     1     3  0.462   0.258       0.911
#>  4          1 head           1     1     4 -0.0770 -0.383       0.610
#>  5          1 head           1     1     5  0.375  -0.682       0.768
#>  6          1 neck           1     1     1  1.96    0.388       0.677
#>  7          1 neck           1     1     2 -1.65   -0.0218      0.871
#>  8          1 neck           1     1     3  1.17    0.361       0.304
#>  9          1 neck           1     1     4 -0.247   0.0162      0.699
#> 10          1 neck           1     1     5  1.61   -0.358       0.758
#> # ℹ 20 more rows
```
...
#>  2 A         1     1 0.169  0.791 
#>  3 A         1     2 0.359  0.772 
#>  4 A         1     2 0.0653 0.979 
#>  5 B         1     1 0.188  0.535 
#>  6 B         1     2 0.771  0.0419
#>  7 B         2     1 0.878  0.435 
#>  8 B         2     2 0.545  0.625 
#>  9 C         2     1 0.605  0.856 
#> 10 C         2     1 0.756  0.778 
#> 11 C         2     2 0.0876 0.928 
#> 12 C         2     2 0.632  0.279
```
