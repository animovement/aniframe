...
#>  1          1 head           1     1     1  0.571  -1.50       0.911
#>  2          1 head           1     1     2  0.501   1.32       0.586
#>  3          1 head           1     1     3 -0.103  -1.62       0.867
#>  4          1 head           1     1     4  1.25    0.393      0.753
#>  5          1 head           1     1     5  0.0153 -2.19       0.624
#>  6          1 neck           1     1     1  1.33   -0.502      0.661
#>  7          1 neck           1     1     2  0.165  -0.313      0.928
#>  8          1 neck           1     1     3 -1.09   -0.577      0.548
#>  9          1 neck           1     1     4  0.717   0.177      0.978
#> 10          1 neck           1     1     5 -1.69   -0.551      0.773
#> # ℹ 20 more rows
```
...
#>  2 A         1     1 0.842  0.975 
#>  3 A         1     2 0.695  0.872 
#>  4 A         1     2 0.0932 0.223 
#>  5 B         1     1 0.0220 0.0355
#>  6 B         1     2 0.0198 0.171 
#>  7 B         2     1 0.566  0.0292
#>  8 B         2     2 0.578  0.726 
#>  9 C         2     1 0.329  0.487 
#> 10 C         2     1 0.382  0.768 
#> 11 C         2     2 0.263  0.948 
#> 12 C         2     2 0.256  0.907
```
