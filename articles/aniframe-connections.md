...
#>  1          1 head           1     1     1 -0.266 -1.16       0.643
#>  2          1 head           1     1     2  0.486 -0.363      0.740
#>  3          1 head           1     1     3 -0.390 -0.585      0.695
#>  4          1 head           1     1     4 -1.14   1.05       0.781
#>  5          1 head           1     1     5  0.111  1.12       0.862
#>  6          1 head           1     1     6 -0.713 -0.245      0.582
#>  7          1 head           1     1     7 -1.78  -0.607      0.710
#>  8          1 head           1     1     8 -0.814 -1.08       0.288
#>  9          1 head           1     1     9 -0.305  1.03       0.808
#> 10          1 head           1     1    10 -0.569 -0.739      0.612
#> # ℹ 740 more rows
```
